...
export declare type Application = 'excel';
export declare type Addin = string;
...
export interface Messages {
    ...
    'patch-remove-dependency': {
        name: string;
    };
    'patch-add-reference': {};
    'patch-remove-reference': {
        name: string;
    };
}
...
export interface Reporter {
    ...
    messages: {
        [T in keyof Messages]: (values: Messages[T]) => string;
    };
    errors: {
        [T in keyof ErrorMessages]: (values: ErrorMessages[T]) => string;
    };
}
...
export declare type MessageId = keyof Messages;
export declare type CliErrorCode = keyof ErrorMessages;
