...
export declare type Dependency = RegistryDependency | PathDependency | GitDependency;
...
export declare type TargetType = 'xlsx' | 'xlsm' | 'xlam';
...
export declare type ManifestType = 'package' | 'project';
